...
import { buildLevel, LEG_CREEKS, LEG_PUNE, LEG_GHATS, LEG_VALLEY, LEG_KAAS } from './level.js';
...
const LEGS = { [LEG_PUNE.id]: LEG_PUNE, [LEG_GHATS.id]: LEG_GHATS, [LEG_VALLEY.id]: LEG_VALLEY, [LEG_KAAS.id]: LEG_KAAS, [LEG_CREEKS.id]: LEG_CREEKS };
